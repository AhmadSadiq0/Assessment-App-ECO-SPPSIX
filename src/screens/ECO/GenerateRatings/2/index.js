...
const GenerateRatings3 = (props) => {
    ...
    const onNextPressed = () => {
        if (calculateRating()) {
            props.navigation.navigate('EcoGenerateRatings3', {
                data: {
                    ...data,
    ...
    return (
        <View style={{
            ...
            <KeyboardAwareScrollView
                ...
                ref={scrollViewRef}
            >
                <Text style={styles.title}>II. Outcome B: Acquire and Use Knowledge and Skills</Text>
                <OptionsText
...
export default GenerateRatings3;